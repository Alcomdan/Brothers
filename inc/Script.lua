...
local inline = {{{text="⚜┇قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/AMAM_19"}}}
send_key(msg.sender_user_id_,'  [⚜┇قناة سورس : الأخوين](t.me/AMAM_19)',nil,inline,msg.id_)
return false
end
...
`./brothers/run`
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
📡┇[قناة السورس](t.me/AMAM_19) @AMAM_19
...
elseif Text== "مطور السورس"  then return sendMsg(msg.chat_id_,msg.id_,"[حـᬽـسـٖٜ·ٖٖٜ.,ٖٖٖٜ¸ٖٖٖٖ³¹³¸ٖٖٖٜ,.ٖٖٜ·ٖٜـوﻧـᬽـي](t.me/hlh313)")
