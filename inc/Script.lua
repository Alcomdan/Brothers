...
return "اهلا بك عزيزي تم تعطيل الايدي بالصوره🏌️‍♀️"
end 
...
return "اهلا بك عزيزي تم تفعيل الايدي بالصوره🏌️‍♀️"
end
...
return '👨🏾‍🔧┊ اصدار سورس الأخوين : احـدث اصـدار \n📡'
end
...
sendMsg(msg.chat_id_,msg.id_,'🔛*┊* تم التحديث \n📡*┊* يتم التحديث  ...')
redis:set(max..":VERSION",GetVerison)
return false
else
return "🔖┊سـورس الأخوين\n👨🏾‍🔧*┊* لديـك احدث اصدار \n📦"
end
return false
end
...
`./Brothers/run`
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
ـ📡┇[قناة السورس](http://t.me/cgngv) @cgngv
👨🏻‍✈️┇[مـطـور الـسـورس الأول](http://t.me/P_P_Z)
👨🏻‍✈️┇[مـطـور الـسـورس الثاني](http://t.me/sajad14p)
]]
end
...
{"تغيير الاشتراك الاجباري 🧟‍♂","الاشتراك الاجباري ⚠️"} في"},
...
⚂┊وارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي الكروب تلقائين م
