...
{"🗂 اضف ملف 🗂","🗂 المنتجر الملفات 🗂"},
{"تفعيل الزخرفه","تعطيل الزخرفه"},
{"نسخه احتياطيه للمجموعات","رفع نسخه الاحتياط"},
{"📷 تفعيل جلب الصوره 📸","📷 تعطيل جلب الصوره 📸"},
 {"قناة السورس 📡"},
 {"تحديث السورس ™"},
 {"الغاء الامر ✖️"}}
...
sendMsg(msg.chat_id_,msg.id_,'🚦┊طبكم مرض باي 💔🚶‍♂') 
