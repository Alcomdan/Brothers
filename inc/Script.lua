...
👨🏻‍✈️┇[مـطـور الـسـورس الأول](http://t.me/sajad14p)
👨🏻‍✈️┇[مـطـور الـسـورس الثاني](http://t.me/P_P_Z)
]]
end
...
{"تنظيف المشتركين 🗑","تنظيف المجموعات 🗑"},
 {"قناة السورس 📡"}","🖨 نسخه احتياطيه للمجموعات"},
 {"تحديث السورس ™"},
 {"الغاء الامر ✖️"}}
...
if not msg.Admin then return "📛*¦* هذا الامر 

يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" 
