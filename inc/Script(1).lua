...
─────▀██▀─────
┊AUA ‿ @sajad14p
تم تطوير وبرمجة السورس من قبل سجودي ┊
┊@sajad14p ‿ @sajad14p 
#-------------------------------------------------------------------
]]
...
if (MsgText[1] == "اضف مدير"  or MsgText[1] == "رفع مدير" ) then
...
if (MsgText[1] == "اضف منشئ" or MsgText[1] == "رفع منشئ") then
...
if MsgText[1] == "تنزيل المطور" then
if not MsgText[2] and msg.reply_id then 
...
return '👨🏾‍🔧┊ اصدار سورس الاخوين : احـدث اصـدار \n📡'
end
...
send_key(msg.sender_user_id_,'  [⚜┇قناة سورس : الاخـويـن ](t.me/cgngv)',nil,inline,msg.id_)
return false
end
